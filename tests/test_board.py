from rnr_mapgen.board import create_empty_map, iter_board_coords
...
def test_full_rectangular_board_area_is_present() -> None:
    config = GeneratorConfig(width=3, height=2, seed=99)
...
def test_iter_board_coords_is_row_major() -> None:
    coords = iter_board_coords(width=3, height=2)
